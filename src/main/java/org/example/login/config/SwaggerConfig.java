...
// JWT需要在“文档管理->全局参数设置”里配置 Authorization : Bearer <TOKEN>
...
public class SwaggerConfig {
    ...
    public Docket docket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 此包路径下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("org.example.login"))
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))  // @ApiOperation：swagger 常用注解，用户标注方法描述
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .title("接口文档")
                // 描述
                .description("user-login-project")
                // 服务条款链接
                .termsOfServiceUrl("https://github.com/htfc786/")
                // 许可证
                .license("user-login-project")
                // 许可证链接
                .licenseUrl("https://github.com/htfc786/")
                // 联系我
                .contact(new Contact(
                        "htfc786",
                        "https://github.com/htfc786/",
                        "htfc786@163.com"))
                // 版本
                .version("1.0")
                .build();
